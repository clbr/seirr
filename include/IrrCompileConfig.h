...
#define IRRLICHT_SDK_VERSION "1.7.3-pse"
...
//! Define __IRR_HAS_S64 if the irr::s64 type should be enable (needs long long, vailable on most platforms, but not part of ISO C++ 98)
