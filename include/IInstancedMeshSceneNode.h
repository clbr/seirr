...
namespace scene
{
	...
	public:
		...
		virtual const core::vector3df& getInstancePosition(u32 num) const = 0;

		//! Gets the rotation of this instance.
		virtual const core::vector3df& getInstanceRotation(u32 num) const = 0;

		//! Gets the scale of this instance.
		virtual const core::vector3df& getInstanceScale(u32 num) const = 0;

		//! Gets the color of this instance.
		virtual const video::SColor& getInstanceColor(u32 num) const = 0;
