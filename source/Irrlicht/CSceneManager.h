...
namespace scene
{
	...
	*/
	...
	public:
		...
		//! destructor
		virtual ~CSceneManager() _IRR_OVERRIDE_;
		...
		virtual IMeshSceneNode* addCubeSceneNode(f32 size=10.0f, ISceneNode* parent=0, s32 id=-1,
			const core::vector3df& position = core::vector3df(0,0,0),	const core::vector3df& rotation = core::vector3df(0,0,0),	const core::vector3df& scale = core::vector3df(1.0f, 1.0f, 1.0f)) _IRR_OVERRIDE_;
		...
		virtual void drawAll(u32 flags = 0xFFFFFFFF) _IRR_OVERRIDE_;
		...
		virtual IAnimatedMesh* addTerrainMesh(const io::path& meshname,	video::IImage* texture, video::IImage* heightmap,
			...
			f32 maxHeight, const core::dimension2d<u32>& defaultVertexBlockSize) _IRR_OVERRIDE_;
		...
		virtual ESCENE_NODE_TYPE getType() const _IRR_OVERRIDE_ { return ESNT_UNKNOWN; }
		...
		virtual bool saveScene(const io::path& filename, ISceneUserDataSerializer* userDataSerializer=0) _IRR_OVERRIDE_;

		//! Saves the current scene into a file.
		virtual bool saveScene(io::IWriteFile* file, ISceneUserDataSerializer* userDataSerializer=0) _IRR_OVERRIDE_;

		//! Loads a scene. Note that the current scene is not cleared before.
		//! \param filename: Name of the file .
		virtual bool loadScene(const io::path& filename, ISceneUserDataSerializer* userDataSerializer=0) _IRR_OVERRIDE_;

		//! Loads a scene. Note that the current scene is not cleared before.
		virtual bool loadScene(io::IReadFile* file, ISceneUserDataSerializer* userDataSerializer=0) _IRR_OVERRIDE_;
