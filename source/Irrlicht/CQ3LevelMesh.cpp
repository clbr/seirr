...
CQ3LevelMesh::CQ3LevelMesh(io::IFileSystem* fs, scene::ISceneManager* smgr,
	...
	Planes(0), NumPlanes(0), Nodes(0), NumNodes(0), Leafs(0), NumLeafs(0), LeafFaces(0),
	NumLeafFaces(0), MeshVerts(0), NumMeshVerts(0), Brushes(0), NumBrushes(0),
	BrushEntities(0), FileSystem(fs), SceneManager(smgr)
{
	#ifdef _DEBUG
