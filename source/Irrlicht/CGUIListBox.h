...
namespace gui
{
	...
	public:
		...
		//! destructor
		virtual ~CGUIListBox() _IRR_OVERRIDE_;
		...
		virtual void setItemOverrideColor(u32 index, const video::SColor &color) _IRR_OVERRIDE_;

		//! set all item colors of specified type at given index to color
		virtual void setItemOverrideColor(u32 index, EGUI_LISTBOX_COLOR colorType, const video::SColor &color) _IRR_OVERRIDE_;
