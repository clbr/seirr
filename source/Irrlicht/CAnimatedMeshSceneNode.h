...
namespace scene
{
	...
	public:
		...
		//! destructor
		virtual ~CAnimatedMeshSceneNode() _IRR_OVERRIDE_;
		...
		virtual ISceneNode* getMS3DJointNode(const c8* jointName) _IRR_OVERRIDE_;

		//! Redundant command, please use getJointNode.
		virtual ISceneNode* getXJointNode(const c8* jointName) _IRR_OVERRIDE_;
