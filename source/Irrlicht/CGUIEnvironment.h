...
public:
	...
	//! destructor
	virtual ~CGUIEnvironment() _IRR_OVERRIDE_;
	...
	virtual IGUIFileOpenDialog* addFileOpenDialog(const wchar_t* title = 0, bool modal=true, IGUIElement* parent=0, s32 id=-1) _IRR_OVERRIDE_;
	...
	virtual bool hasFocus(IGUIElement* element) const _IRR_OVERRIDE_;
